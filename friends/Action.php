<?php
class friends_Action extends Typecho_Widget implements Widget_Interface_Do
{
	private $db;
	private $options;
	private $prefix;
	...
	{
		if (friends_Plugin::form('insert')->validate()) {
		...
		/** 转向原页 */
		$this->response->redirect(Typecho_Common::url('extending.php?panel=friends%2Fmanage-links.php', $this->options->adminUrl));
	}

	public function updateLink()
	{
		if (friends_Plugin::form('update')->validate()) {
			$this->response->goBack();
		}
