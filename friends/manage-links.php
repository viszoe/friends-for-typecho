        ...
        <div class="row typecho-page-main manage-metas">
                <div class="col-mb-12">
                    <ul class="typecho-option-tabs clearfix">
                        <li class="current"><a href="<?php $options->adminUrl('extending.php?panel=friends%2Fmanage-links.php'); ?>"><?php _e('友情链接'); ?></a></li>
                    </ul>
                </div>
                ...
                <div class="col-mb-12 col-tb-8" role="main">                  
                    <?php
						$prefix = $db->getPrefix();
						$links = $db->fetchAll($db->select()->from($prefix.'links')->order($prefix.'links.order', Typecho_Db::SORT_DESC));
                    ?>
                                ...
                                <tr id="lid-<?php echo $link['lid']; ?>">
									...
									<td><?php
										if ($link['image']) {
											...
											$nopic_url = Typecho_Common::url('/usr/plugins/friends/nopic.jpg', $options->siteUrl);
                ...
                <div class="col-mb-12 col-tb-4" role="form">
                    <?php friends_Plugin::form()->render(); ?>
                </div>
        </div>
    </div>
</div>
